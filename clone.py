...
class YC:
    def __init__(self, email, pw):
        ...
        try:
            ...
            print ("\033[31m[\033[32m!\033[31m] \033[39mLogin Succes")
            print ("\033[36m" + 50*"-")
            print ("\033[36m|" + 11*" " + "\033[35mlogin mank\nEmail" + 11*" " + "\033[36m|" + 8*" " + "\033[33mVuln" + 8*" " + "\033[36m|")
            print ("\033[36m" + 50*"-")
        except KeyError:
            print ("\033[31m[\033[31m!\033[31m] \033[39mLogin Failed")
            sys.exit()
